...
class SignupView extends Component {
    ...
    handleSignup = e => {
        ...
        if(!agree){
            this.setState({
                errorTerms:'You should agree with privacy policy.',
                alertModal:true
            });
            return
        } else {
                ...
                if(error.response.data) {
                    ...
                    if(errordata.password) {
                        if((errordata.password[0]).indexOf('blank')!==-1){
                            this.setState({errorpassword:'Password error'})
                        }
                    }
                    if(errordata.accountName) {
                        if((errordata.accountName[0]).indexOf('exists')!==-1)
                        {
                            this.setState({erroraccountName:'Account Name already exists.'})
                        }
            ...
            <>
                <div className="top">
                    ...
                    <div className="top-login-btns">
                        <a onClick={this.handleSignup}>CREATE AN ACCOUNT</a>
                ...
                <div className={`modal ${successModal? "modal-show" : ""}`} onClick={this.modalClose}>
